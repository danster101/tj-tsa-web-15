...
<ul class="arrow-bullet">
    ...
    <li><b>Advanced Communications Data Streaming</b>: A semester introduction to the theory of data exchange and implementations of communications systems.</li>
    ...
    <li><b>Alternative Energy Systems (Energy Systems 2)</b>: A semester study of topics of alternative energy, including thermodynamic systems, power sources for combustion engines, fuel cell processes, and other developing technologies.</li>
...
<ul class="arrow-bullet">
    ...
    <li>Chemical Analysis &amp; Nanochemistry</li>
    <li>Engineering Design (formerly Computer Aided Design)</li>
    <li>Computer Systems</li>
    <li>Energy Systems</li>
    <li>Microelectronics</li>
    <li>Moble and Web Application Development (new for Class of 2015)</li>
    <li>Neuroscience</li>
    <li>Oceanography &amp; Geophysical Systems</li>
    <li>Quantum Physics &amp; Optics</li>
    <li>Protyping &amp; Engineering Materials</li>
</ul>
