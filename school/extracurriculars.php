...
<ul>
    ...
    <li><a target="_blank" href="http://www.tjhsst.edu/~emglazer/stembassadors/">STEMBassadors</a></li>

    <li><a target="_blank" href="http://www.theprojectbest.org/">Project BEST (Building Excitment in Science and Technology)</a></li>

    <li><a target="_blank" href="http://www.kastvirginia.org/tjhsst.html">Kids are Scienctists Too (KAST)</a></li>

    <li>Electronics Club (XSTEM)</li>

    <li>Environmental Science Club</li>

    <li><a target="_blank" href="https://activities.tjhsst.edu/wise/">Women in Science and Engineering (WISE)</a></li>
...
<ul>
    ...
    <li>Assistive Technology Club</li>
...
<ul>
    ...
    <li>Biology Society</li>

    <li><a target="_blank" href="https://activities.tjhsst.edu/chemsoc/">Chemistry Olympiad</a></li>

    <li>DNA Society</li>

    <li><a target="_blank" href="https://activities.tjhsst.edu/gems/">Girls in Engineering, Math, and Science (GEMS)</a></li>

    <li>Varsity Math Team (VMT)</li>

    <li>Neuroscience Society</li>

    <li><a target="_blank" href="http://activities.tjhsst.edu/physics/">Physics Team</a></li>

    <li><a target="_blank" href="http://activities.tjhsst.edu/twist/boxes.html">Tomorrows' Women in Science and Technology (TWIST)</a></li>
