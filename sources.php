<html>
	...
	<?php make_head("Sources"); ?>
	<body>
		<?php make_header("Sources"); ?>
			...
			<main>
				<article>
					<div class="content">
						...
						<h3>Home Page Slider<a name="index"></a></h3>
						...
						<ul class="arrow-bullet">
							<li>All information - <a target="_blank" href="http://en.wikipedia.org/wiki/Thomas_Jefferson_High_School_for_Science_and_Technology">Wikipedia on TJHSST</a></li>
							<li>TJHSST Blueprint Image - <a target="_blank" href="http://bjuarchitects.com/test%20k-12%20education.html">K-12 Educational Architects Projects</a></li>
						...
						<ul class="arrow-bullet">
							...
							<li>STEM Logo - <a target="_blank" href="http://www.apsu.edu/stem">Austin Peay State University</a></li>
							<li>IBET Robotics Photo - <a target="_blank" href="http://www.tjtoday.org/4681/news/freshman-prepare-for-annual-ibet-robot-competition/#prettyPhoto/0/">tjTODAY Online</a></li>
							<li>Other Photos - Taken by TJHSST TSA Webmaster Team</li>
						...
						<ul class="arrow-bullet">
							...
							<li>TJHSST Activities Word Map - <a target="_blank" href="http://www.tjhsst.edu/students/activities/">TJHSST Activites Site</a></li>
							<li>Stembassadors Photo - <a target="_blank" href="http://www.tjhsst.edu/~emglazer/stembassadors/">TJHSST Stembassadors Site</a></li>
							<li>Electronics Project Photo - <a target="_blank" href="https://www.tjhsst.edu/">TJHSST Site</a></li>
						...
						<ul class="arrow-bullet">
							<li>List of Events - <a target="_blank" href="http://tsaweb.org">National TSA Site</a></li>
							<li>All images - Various TJHSST TSA photographers</li>
						</ul>
